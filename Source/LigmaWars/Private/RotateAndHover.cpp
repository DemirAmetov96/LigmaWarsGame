...
#include "RotateAndHover.h"

// Sets default values
// Sets default values
ARotateAndHover::ARotateAndHover()
{
...
void ARotateAndHover::BeginPlay()
{
	Super::BeginPlay();
	if (HasAuthority()) {
		SetReplicates(true);
...
void ARotateAndHover::MakeObjectRotate(float DeltaTime)
{
...
void ARotateAndHover::MakeObjectFloat(float DeltaTime)
{
...
// Called every frame
void ARotateAndHover::Tick(float DeltaTime)
{
